...
var $textN = 0
//contador de la posición de array
var $arrayN = -1
$(document).ready(function() {
  ...
  $(document).on('click','#btn_inputs', function() {
    ...
    var $element = $('<div id="'+$arrayN+'" class="draggableResizable draggableinput" style="position: absolute"/>').append('<label for="exercise_input"><input id="input-'+$inputN+'" type= text name="exercise[input'+$inputN+']"/>Input <a class="close" href="#">x</a> </label>');
    // console.log($element);
    $array.push($element);
    ...
    $("#work_area").on("click",".close",function(event){
        ...
        //guardamos en la variable delete el div, que es el padre general del elemento .close
...
$(document).on('click','#btn_text', function() {
  // sumar uno al inputN
      ...
      // console.log("en creacion_de_ejercicios.html.js se ha dado click al boton con id #btn_inputs");
      // asignar al un div draggableResizable y anexarle un label  y name para que el botón "terminar trabajo" envíe los datos al params
      var $element = $('<div id="'+$arrayN+'" class="draggableResizable draggabletext" style="position: absolute" />').append('<label for="exercise_input"><input id="text-'+$textN+'" type= text name="exercise[text'+$textN+']" />Texto <a class="close" href="#">x</a></label>');
      // console.log($element);
      $array.push($element);
      //append it to the DOM
      $("#work_area").append($element);
